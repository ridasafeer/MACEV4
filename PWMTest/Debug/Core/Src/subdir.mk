...
../Core/Src/timer_pwm_lib_backup_code.c 
...
./Core/Src/timer_pwm_lib_backup_code.o 
...
./Core/Src/timer_pwm_lib_backup_code.d 
...
Core/Src/timer_pwm_lib_backup_code.o: ../Core/Src/timer_pwm_lib_backup_code.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m7 -std=gnu11 -g3 -DUSE_HAL_DRIVER -DSTM32F767xx -DDEBUG -c -I../Core/Inc -I../Drivers/STM32F7xx_HAL_Driver/Inc -I../Drivers/STM32F7xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32F7xx/Include -I../Drivers/CMSIS/Include -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/timer_pwm_lib_backup_code.d" -MT"$@" --specs=nano.specs -mfpu=fpv5-d16 -mfloat-abi=hard -mthumb -o "$@"
