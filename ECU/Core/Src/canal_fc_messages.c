...
TeCanALRet Unmarshal_AMK1_SetPoints1(uint8_t *RxData) {
	uint64_t data;
...
TeCanALRet Unmarshal_AMK0_SetPoints1(uint8_t *RxData) {
	uint64_t data;
...
static const struct {
	...
	{ AMK1_SETPOINTS1_CANAL_ID,              &Unmarshal_AMK1_SetPoints1 },
	...
	{ AMK0_SETPOINTS1_CANAL_ID,              &Unmarshal_AMK0_SetPoints1 },
